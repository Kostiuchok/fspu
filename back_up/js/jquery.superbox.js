...
;(function($){
	...
	function initLoading(callback){
		...
		if (galleryMode){
			...
			$overlay.css("opacity", 0).show().fadeTo(0, settings.overlayOpacity, loading);
		}
	};
	...
	function createElements(){
		if (!$.superbox.elementsReady){
			...
			// Add close button
			$closeBtn = $('<ul class="social1 w20"><li><a href="javascript:void(0)" class="close"></a></li></ul>').prependTo($superbox).find("a");
