...
//  rutube
"rutube" => "
   <object type=\"application/x-shockwave-flash\" style=\"width:{WIDTH}px;height:{HEIGHT}px;\" data=\"http://video.rutube.ru/{SOURCE}\" title=\"JoomlaWorks AllVideos Player\">
      <param name=\"movie\" value=\"http://video.rutube.ru/{SOURCE}\" />
      <param name=\"wmode\" value=\"{TRANSPARENCY}\" />
      <param name=\"quality\" value=\"high\" />
      <param name=\"bgcolor\" value=\"{BACKGROUND}\" />
   </object>
